...
class MyFrame(wx.Frame):
    ...
    def __init__(self):
        ...
        self.btn_div = wx.Button(
            self.pl,
            label="/",
            pos=(self.pos_x + 60, self.pos_y),
            size=(self.btn_w, self.btn_h),
        )
        self.btn_mul = wx.Button(
            self.pl,
            label="*",
            pos=(self.pos_x + 120, self.pos_y),
            size=(self.btn_w, self.btn_h),
        )
        self.btn_back = wx.Button(
            self.pl,
            label="<-",
            pos=(self.pos_x + 180, self.pos_y),
            size=(self.btn_w, self.btn_h),
        )
        # 第 2 行
        self.btn_7 = wx.Button(
            self.pl,
            label="7",
            pos=(self.pos_x, self.pos_y + 60),
            size=(self.btn_w, self.btn_h),
        )
        self.btn_8 = wx.Button(
            self.pl,
            label="8",
            pos=(self.pos_x + 60, self.pos_y + 60),
            size=(self.btn_w, self.btn_h),
        )
        self.btn_9 = wx.Button(
            self.pl,
            label="9",
            pos=(self.pos_x + 120, self.pos_y + 60),
            size=(self.btn_w, self.btn_h),
        )
        self.btn_sub = wx.Button(
            self.pl,
            label="-",
            pos=(self.pos_x + 180, self.pos_y + 60),
            size=(self.btn_w, self.btn_h),
        )
        # 第 3 行
        self.btn_4 = wx.Button(
            self.pl,
            label="4",
            pos=(self.pos_x, self.pos_y + 120),
            size=(self.btn_w, self.btn_h),
        )
        self.btn_5 = wx.Button(
            self.pl,
            label="5",
            pos=(self.pos_x + 60, self.pos_y + 120),
            size=(self.btn_w, self.btn_h),
        )
        self.btn_6 = wx.Button(
            self.pl,
            label="6",
            pos=(self.pos_x + 120, self.pos_y + 120),
            size=(self.btn_w, self.btn_h),
        )
        self.btn_add = wx.Button(
            self.pl,
            label="+",
            pos=(self.pos_x + 180, self.pos_y + 120),
            size=(self.btn_w, self.btn_h),
        )
        # 第 4 行
        self.btn_1 = wx.Button(
            self.pl,
            label="1",
            pos=(self.pos_x, self.pos_y + 180),
            size=(self.btn_w, self.btn_h),
        )
        self.btn_2 = wx.Button(
            self.pl,
            label="2",
            pos=(self.pos_x + 60, self.pos_y + 180),
            size=(self.btn_w, self.btn_h),
        )
        self.btn_3 = wx.Button(
            self.pl,
            label="3",
            pos=(self.pos_x + 120, self.pos_y + 180),
            size=(self.btn_w, self.btn_h),
        )
